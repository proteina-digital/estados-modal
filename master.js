...
var libera_e_mostra_modal_promo = function(){
  $(".modal-promocional").removeClass('n_mostra name');

  mostra_modal_promocao();
}

var mostra_modal_promocao = function(){
  var modal = $(".modal-promocional");

  if ( !modal.hasClass('n_mostra') ) {
